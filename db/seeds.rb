...
t3 = Tweetthread.create(id: 3, title:'Test Thread #3', description: 'my third thread!', user_id: u1.id)
t4 = Tweetthread.create(id: 4, title:'Test Thread #4', description: 'my fourth thread!', user_id: u2.id)
t5 = Tweetthread.create(id: 5, title:'Test Thread #5', description: 'my fifth thread!', user_id: u1.id)
t6 = Tweetthread.create(id: 6, title:'Test Thread #6', description: 'my sixth thread!', user_id: u1.id)
t7 = Tweetthread.create(id: 7, title:'Test Thread #7', description: 'my seventh thread!', user_id: u2.id)
t8 = Tweetthread.create(id: 8, title:'Test Thread #8', description: 'my eighth thread!', user_id: u2.id)
